...
export const metadata: Metadata = {
  title: "DialedWeb - Professional Web Development Agency",
  description: "Transform your business with professional web development services. Custom websites, SEO optimization, and full-stack development that drives results.",
  keywords: "web development, web design, SEO, website development, professional websites, custom web development",
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://images.pexels.com/photos/5926393/pexels-photo-5926393.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "DialedWeb web development services"
      }
    ]
  },
  twitter: {
    ...
    title: "DialedWeb - Professional Web Development Agency",
    description: "Transform your business with professional web development services. Custom websites, SEO optimization, and full-stack development that drives results.",
    images: ["https://images.pexels.com/photos/5926393/pexels-photo-5926393.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
